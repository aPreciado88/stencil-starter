...
export class EmojiRain {
  ...
  private giveMeARandomEmoji = (): object => {
    var emoji: Emoji;
    emoji.code = this.emojiUnicode[Math.floor((Math.random() * 10))];
  ...
  render() {
    return (
      <Host id="emoji-rain">
        {/*<template>*/}
          <canvas id="canvas" ref={el => this.canvas = el as HTMLCanvasElement}></canvas>
        {/*</template>*/}
      </Host>
    );
  }
